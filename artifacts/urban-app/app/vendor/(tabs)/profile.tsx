      ...
      <View style={[styles.profileCard, { backgroundColor: colors.card, borderColor: colors.border }]}> 
        {user?.profileImageUrl ? (
          ...
          <View style={[styles.avatarFallback, { backgroundColor: colors.primary }]}>
            <Text style={styles.avatarInitial}>{(user?.firstName?.[0] ?? "P").toUpperCase()}</Text>
          </View>
        )}
        <View style={styles.profileInfo}>
          ...
          <View style={styles.badgeRow}>
            <View style={[styles.roleBadge, { backgroundColor: colors.primary + "18" }]}>
              ...
              <Text style={[styles.roleText, { color: colors.primary }]}>Service Provider</Text>
            </View>
            ...
            <View key={ri}>
              ...
              >
                <View
                  style={[
                    styles.menuIcon,
                    { backgroundColor: row.color ? row.color + "15" : colors.muted },
                  ]}
                >
