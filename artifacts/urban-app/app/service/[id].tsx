...
export default function ServiceDetailScreen() {
  ...
  const providers = PROVIDERS.slice(0, 3);
  ...
  const imgSource = IMAGE_MAP[service.image] || IMAGE_MAP["cleaning"];

  const handleBook = () => {
    if (Platform.OS !== "web") Haptics.impactAsync(Haptics.ImpactFeedbackStyle.Medium);
    router.push(`/booking/${id}?providerId=${selectedProvider}`);
  };

  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      <View style={[styles.backBtn, { top: insets.top + (Platform.OS === "web" ? 67 : 0) + 8 }]}>
        <Pressable
          onPress={() => router.back()}
        ...
        <Pressable
          onPress={() => toggleSavedService(service.id)}
          style={[styles.iconBtn, { backgroundColor: "rgba(255,255,255,0.9)" }]}
        >
          <Feather
            name="heart"
          ...
          <View style={[styles.section, { borderColor: colors.border }]}>
            ...
            <View style={styles.providerList}>
              {providers.map((provider) => {
                ...
                const avatarColors = ["#f97316", "#3b82f6", "#10b981"];
                ...
                return (
                  ...
                  >
                    <View style={[styles.providerAvatar, { backgroundColor: avatarColor + "22" }]}>
